...
<html lang="en" data-theme="dark"><head>
  ...
  <script src="../../shared/datasheet-layout.js?v=2"></script><script src="../../shared/rule-facts.js?v=1"></script><script src="../../shared/related-rules-matcher.js?v=3"></script><script src="../scripts/related-rules.js?v=8"></script>
  ...
  <script src="../../../glossary-return.js?v=3"></script><script src="../../shared/roster-parser.js?v=2"></script><script src="../../shared/roster-entities.js?v=1"></script><script src="../../../roster-guides/points-data.js?v=6"></script><script src="../scripts/roster-enhancements.js?v=2"></script><script src="./mobile.js?v=3"></script>
</body></html>`;
}
