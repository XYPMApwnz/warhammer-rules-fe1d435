  ...
  if(rosterMode){
    ...
    try{
      ...
      if(unit){
        ...
        window.AMRosterEnhancements.decorate(unit,parsed,currentCard.instances,{attachments:record.attachments||{},unitById:new Map(parsed.units.map(item=>[item.id,item])),detachmentIds:rosterContext.detachmentIds});
