...
assert.equal(Object.keys(snapshot.units).length,38);
assert.equal(Object.keys(snapshot.coreUnits).length,38);
assert.deepEqual(summary.datasheets,{canonical:38,imported:38});
...
assert.deepEqual(summary.associations,{faction:902,core:250});
...
console.log('PASS Mechanicus Wahapedia compatible-rules snapshot: 38 datasheets, 902 faction and 250 Core associations');
