...
check('personal roster integration is loaded',html.includes('../shared/roster-parser.js?v=2')&&html.includes('../../roster-guides/points-validator.js?v=4')&&html.includes('./scripts/roster-filter.js?v=4')&&html.includes('data-roster-guides'));
...
check('Compatible Rules assets and unverified Stratagem labels use the current contract',read('scripts/app.js').includes("fetch('./mobile/related-rules.inc?v=4')")&&read('mobile/mobile.js').includes("fetch('./related-rules.inc?v=4')")&&html.includes('./scripts/app.js?v=34')&&read('mobile/index.html').includes('./mobile.js?v=16')&&honestStratagemLabels(html)&&honestStratagemLabels(read('mobile/related-rules.inc')));
