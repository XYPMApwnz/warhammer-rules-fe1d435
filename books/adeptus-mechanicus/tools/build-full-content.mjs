...
const releaseHtml=html
  ...
  .replace('<script src="./scripts/related-rules.js?v=6">','<script src="../shared/related-rules-matcher.js?v=3"></script><script src="../shared/modal-focus.js?v=1"></script><script src="./scripts/related-rules.js?v=9">')
