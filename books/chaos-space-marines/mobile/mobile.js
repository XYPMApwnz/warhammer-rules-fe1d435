(async function(){
  ...
  function rosterContext(){
    ...
    const enhancementRuleIds=new Set(window.WHBookRosterEnhancements?.assignedRuleIds(roster,entry?.units||[])||[]);
    return{record,roster,selected,entry,detachments,enhancementRuleIds};
  }
