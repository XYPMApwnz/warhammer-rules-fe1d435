(function(root){
  ...
  root.CSM_ROSTER_SEMANTICS=Object.freeze({schema:'wh40k-structured-effect-provider/v1',gameEffects,projectEffects:gameEffects});
  const install=()=>{if(!root.WHArmyRosterContext||!root.WHEffectContractRuntime)return false;root.WHArmyRosterContext.install({bookId:'chaos-space-marines',guideGlobal:'CSM_ROSTER_GUIDE',provider});return true;};
