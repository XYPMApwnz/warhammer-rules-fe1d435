...
if(detachmentIds.length!==10||unitIds.length!==23)throw new Error(`Expected 10 detachments and 23 datasheets, found ${detachmentIds.length} and ${unitIds.length}`);
...
const page=({target})=>`<!doctype html><html lang="en" data-theme="dark" data-canonical-reader="../reader.html" data-canonical-target="${target}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="theme-color" content="#0a0b0d"><title>Emperor's Children Rules</title><link rel="manifest" href="../../../manifest.webmanifest"></head><body><noscript><a href="../reader.html#${target}">Open the canonical Emperor's Children reader</a></noscript><script src="../../shared/mobile-route-redirect.js?v=1"></script></body></html>\n`;
...
console.log(`Emperor's Children compatibility routes ${check?'verified':'built'}: ${routes.length} content-free stubs.`);
