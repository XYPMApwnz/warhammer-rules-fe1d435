...
vm.runInNewContext(fs.readFileSync(path.join(bookRoot,'scripts','target-data.js'),'utf8'),targetContext);
const targetData=targetContext.window.WH_ARMY_BOOK_TARGETS;
const content=targetData.html;
