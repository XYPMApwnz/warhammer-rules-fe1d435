(function(root){
  ...
  root.ECRosterSemantics=Object.freeze({schema:'wh40k-structured-effect-provider/v1',gameEffects,projectEffects:gameEffects});
  const install=()=>{if(!root.WHArmyRosterContext||!root.WHEffectContractRuntime)return false;root.WHArmyRosterContext.install({bookId:'emperors-children',guideGlobal:'EC_ROSTER_GUIDE',provider});return true;};
