(function(root){
  ...
  function presentEffects(card,gameUnit,projection){
    const effects=list(gameUnit.effects).filter(effect=>!(effect.component==='ability'&&effect.operation==='reference'));if(!effects.length)return;
