...
const normalizedHtml=html
  ...
  .replace('<script src="../shared/popup-rule-actions.js">',`${config.responsiveSingleTarget?'<script src="../shared/responsive-book-target.js?v=1"></script>':''}<script src="../shared/popup-rule-actions.js">`)
