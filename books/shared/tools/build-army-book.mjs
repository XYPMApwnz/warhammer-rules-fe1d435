...
const effectContracts=effectiveEffectContracts([effectContractSet,...dependencyCodices.map(item=>item.effectContracts)],config.id);
const rosterCatalog=createRosterCatalog({config,units,detachments,relationGraphs,legacyEnhancements:rosterEnhancements,enhancementContracts:canonicalRosterEnhancements,keywordGrants:relatedRules?.keywordGrants||[],effectContracts});
