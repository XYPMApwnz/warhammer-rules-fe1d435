...
const normalizedHtml=html
  ...
  .replace('../shared/controllers/ui-controllers.js"','../shared/controllers/ui-controllers.js?v=12"')
...
const canonicalReaderIndexHtml='<!doctype html><html lang="en" data-theme="dark" data-canonical-reader="./reader.html" data-canonical-target="start"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="theme-color" content="#0a0b0d"><title>'+esc(config.title)+' Rules</title><link rel="manifest" href="../../manifest.webmanifest"></head><body><noscript><a href="./reader.html#start">Open the canonical '+esc(config.title)+' reader</a></noscript><script src="../shared/mobile-route-redirect.js?v=1"><\/script></body></html>\n';
