...
const unitCard=unit=>{
  ...
  const parts={profile:`${base}-profile`,abilities:`${base}-abilities`,composition:`${base}-composition`,...((unit.relations?.leader||[]).length?{leader:`${base}-leader`}:{}),keywords:`${base}-keywords`};
