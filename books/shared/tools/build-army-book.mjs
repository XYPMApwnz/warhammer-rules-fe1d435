...
const finalHtml=config.dedicatedMobile?normalizedHtml
  ...
  .replace('./styles/book.css?v=2','./styles/book.css?v=3')
  .replace('./scripts/app.js?v=3','./scripts/app.js?v=4')
...
const outputs=new Map([
  ['reader.html',finalHtml],['index.html',indexHtml],['scripts/data.js',dataJs],...(config.dedicatedMobile?[]:[['scripts/app.js',appJs],['styles/book.css',normalizedBookCss]]),...(config.dedicatedMobile?[['mobile/related-rules.source.inc',relatedInc+'\n']]:[['mobile/index.html',mobileIndex],['mobile/related-rules.inc',relatedInc+'\n']])
]);
const errors=[];
