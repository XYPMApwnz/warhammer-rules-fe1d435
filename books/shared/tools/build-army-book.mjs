...
finalHtml=finalHtml.replace(/<script src="\.\.\/shared\/army-book-app\.js\?v=\d+"><\/script>/,match=>`<script src="../shared/roster-context.js?v=${runtimeVersions.shared.rosterContext}"></script>${match}`);
