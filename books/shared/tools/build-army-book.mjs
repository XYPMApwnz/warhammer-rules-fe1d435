...
const detachmentHtml=detachments.map(det=>{
  ...
  const stratagemSection=stratagems?`<section class="detachment-part" id="${esc(det.id)}-stratagems" data-track="${esc(det.id)}-stratagems"><h4 class="subheading">Stratagems</h4><div class="detachment-grid">${stratagems}</div></section>`:'';
