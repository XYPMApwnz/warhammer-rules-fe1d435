...
finalHtml=finalHtml.replace(/<script src="\.\.\/shared\/army-book-app\.js\?v=\d+"><\/script>/,match=>`<script src="../shared/roster-context.js?v=${config.assetVersions?.rosterContext||1}"></script>${match}`);
