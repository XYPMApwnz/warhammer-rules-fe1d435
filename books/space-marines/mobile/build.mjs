...
const compatibleMatrix=JSON.parse(await readFile(new URL('../generated/compatible-rules.json',import.meta.url),'utf8'));
const compatibleUnits=new Set(Object.entries(compatibleMatrix.units).filter(([,rules])=>rules.length).map(([id])=>id));
