(async function(){
  ...
  let source=null;
  try{source=await matrixRuntime.loadCompatibleRulesSource(new URL('../generated/compatible-rules.json',scriptUrl),{schema:'tau-empire-compatible-rules/v1',conditionLabels,resolveDetachmentSelection:true});}
  ...
  window.WHArmyBook.install({
    ...
    relatedRules:source?{
      ...
      conditionLabels,
      rosterGuide:()=>window.TAU_ROSTER_GUIDE,
