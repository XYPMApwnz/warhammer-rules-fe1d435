...
AB-CONTENT-002|partial|real-browser-automated-integration|tests/browser/cold-offline.mjs|All 31 faction and 10 Core Stratagems preserve exactly one visible canonical type label across desktop, Phone, roster, and dynamic Related Rules; type metadata, computed color, and separate turn timing share one deterministic contract.|source-authority|Seven faction Stratagem types remain explicitly unverified because complete official Codex authority is absent.
