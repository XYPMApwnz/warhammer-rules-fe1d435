...
export function buildImport({pages,retrievedAt}){
  ...
  source.rules.filter(rule=>!seenRules.has(rule.ruleId)).forEach(rule=>unresolved.unknown.push({kind:'canonical-stratagem',ruleId:rule.ruleId,reason:'not observed'}));
