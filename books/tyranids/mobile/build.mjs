...
if(detachmentIds.length!==10||unitIds.length!==50)throw new Error(`Expected 10 detachments and 50 datasheets, found ${detachmentIds.length} and ${unitIds.length}`);
...
const page=({target})=>`<!doctype html><html lang="en" data-theme="dark" data-canonical-reader="../reader.html" data-canonical-target="${target}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="theme-color" content="#0a0d12"><title>Tyranids Rules</title><link rel="manifest" href="../../../manifest.webmanifest"></head><body><noscript><a href="../reader.html#${target}">Open the canonical Tyranids reader</a></noscript><script src="../../shared/mobile-route-redirect.js?v=1"></script></body></html>\n`;
...
console.log(`Tyranids compatibility routes ${check?'verified':'built'}: ${routes.length} content-free stubs.`);
