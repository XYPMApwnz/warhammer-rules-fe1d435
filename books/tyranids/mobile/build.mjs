...
for(const route of routes)await writeFile(new URL(route.file,import.meta.url),page(route).replace('army-related-rules.js?v=6','army-related-rules.js?v=8').replace('rule-facts.js?v=1','rule-facts.js?v=3'));
