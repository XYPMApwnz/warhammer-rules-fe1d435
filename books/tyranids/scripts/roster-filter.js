(function(root){
  ...
  root.TYRANIDS_ROSTER_SEMANTICS=Object.freeze({schema:'wh40k-structured-effect-provider/v1',gameEffects,projectEffects:gameEffects});
  const install=()=>{if(!root.WHArmyRosterContext||!root.WHEffectContractRuntime)return false;root.WHArmyRosterContext.install({bookId:'tyranids',guideGlobal:'TYRANIDS_ROSTER_GUIDE',provider});return true;};
