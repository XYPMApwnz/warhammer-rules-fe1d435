...
AB-CONTENT-002|partial|schema-data-qa|books/tyranids/tests/codex-source-parity.cjs|The inventory covers 51 Stratagems and 34 Enhancement point records deterministically.|source-authority|Six Codex Detachments rely on frozen community or secondary transcription evidence.
...
AB-ROSTER-004|pass|real-browser-automated-integration|tests/browser/cold-offline.mjs|Desktop and Phone resolve faction, canonical units, one canonical Detachment, and the current Phone route before replacement navigation terminates invalid roster initialization.||
