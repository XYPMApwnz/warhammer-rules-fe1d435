...
| Closing sequence/scoring and Appendix (`reference-page-08-battle-victor-scoring`, `reference-page-09-appendix`) | Steps 12-14 are read during `01:41:49-01:45:28`. Both physical booklet pages are fully readable at `01:45:34-01:45:36`, including the VP table and all five Appendix sections. The bounded evidence artifact records the structured facts and locators. | `RESOLVED_PUBLIC_FOR_RULES_CONTENT`, high confidence, physical-source corroborated |
...
The current [Mission Deck 2026-27 page](https://wahapedia.ru/wh40k11ed/the-rules/mission-deck-2026-27/) identifies itself as Warhammer 40,000 11th edition and binds its content to Chapter Approved 2026-27. It is accepted here as `SECONDARY_CONTENT_SOURCE`, not as official authority. Its authenticated 477,202-byte capture contains the card corpus and Chapter Approved Battles sequence through `Resolve Pre-battle Rules` (Steps 1-11); it does **not** contain Steps 12-14 or the Appendix and is not evidence for those records. The separate `chapter-approved-2026-27-booklet-pages-08-09-evidence.json` artifact enrolls the readable physical-review frames and timestamped transcript for the closing sequence, scoring table and Appendix. Its six Deployment image references, retrieved on 2026-09-22, are:
