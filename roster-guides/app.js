...
const KNOWN_FACTIONS=new Set(['death guard','adeptus mechanicus','tyranids','t au empire','emperor s children']);
const FACTION_ALIASES=Object.freeze({'tau empire':'t au empire'});
const FACTION_PARENTS=Object.freeze({'death guard':'chaos','adeptus mechanicus':'imperium','tyranids':'xenos','t au empire':'xenos','emperor s children':'chaos'});
const FACTION_LABELS=Object.freeze({'death guard':'Death Guard','adeptus mechanicus':'Adeptus Mechanicus','tyranids':'Tyranids','t au empire':"T'au Empire",'emperor s children':"Emperor's Children"});
const FACTION_READERS=Object.freeze({'death guard':'../books/death-guard/reader.html','adeptus mechanicus':'../books/adeptus-mechanicus/index.html','tyranids':'../books/tyranids/index.html','t au empire':'../books/tau-empire/index.html','emperor s children':'../books/emperors-children/index.html'});
