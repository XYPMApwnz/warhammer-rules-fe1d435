...
const KNOWN_FACTIONS=new Set(['death guard','adeptus mechanicus','tyranids','t au empire','emperor s children','chaos space marines']);
const FACTION_ALIASES=Object.freeze({'tau empire':'t au empire'});
const FACTION_PARENTS=Object.freeze({'death guard':'chaos','adeptus mechanicus':'imperium','tyranids':'xenos','t au empire':'xenos','emperor s children':'chaos','chaos space marines':'chaos'});
const FACTION_LABELS=Object.freeze({'death guard':'Death Guard','adeptus mechanicus':'Adeptus Mechanicus','tyranids':'Tyranids','t au empire':"T'au Empire",'emperor s children':"Emperor's Children",'chaos space marines':'Chaos Space Marines'});
...
function pointsLabel(value){return ['adeptus mechanicus','tyranids','t au empire','chaos space marines'].includes(knownFaction(value))?'Official MFM total':'Army Book total';}
