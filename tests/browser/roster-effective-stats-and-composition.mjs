...
try{
  ...
  const sorrowsyphonRecord=sorrowsyphonFixture('sorrowsyphon-poxwalkers');
  {
    ...
    try{
      ...
      assert.deepEqual({kind:state.source?.kind,id:state.source?.id,owner:state.source?.ownerInstanceId,component:state.component,operation:state.operation,targetId:state.targetId},{kind:'enhancement',id:sorrowsyphon.id,owner:'parsed-unit-1',component:'weapon',operation:'add-stat',targetId:'unit-malignant-plaguecaster-weapon-family-plague-wind'});
