...
assert.doesNotMatch(enhancementProvider,/explicit-attachment/,'Enhancement target semantics must remain exact-owner; explicit attachment is reserved for canonical Ability paths');
