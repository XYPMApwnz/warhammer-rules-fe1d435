...
check('all five style layers are linked',cssFiles.every(file=>html.includes('href="./'+file+(file==='styles/content.css'?'?v=37':file==='styles/popups.css'?'?v=17':file==='styles/navigation.css'?'?v=12':file==='styles/tokens.css'?'?v=11':'?v=10')+'"')));
