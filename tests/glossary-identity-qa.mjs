...
assert.equal(registryIds.length,3250,'current canonical glossary inventory changed unexpectedly');
assert.equal(crypto.createHash('sha256').update([...registryIds].sort().join('\n')).digest('hex'),'f525270d62ca7a42fae9fc5366317012745bbdc8ae22bb154b4772551f10ee6d','current canonical glossary identity set changed unexpectedly');
