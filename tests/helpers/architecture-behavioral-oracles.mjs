...
export const CONTRACT_ORACLE_SCRIPTS=Object.freeze({
  ...
  EFFECTIVE_MODEL:['tests/effective-model-convergence-qa.mjs','tests/enhancement-text-ownership-qa.mjs','tests/roster-base-stat-ownership-qa.mjs'],
  ...
  ROSTER:['tests/roster-fixtures-qa.mjs','tests/enhancement-text-ownership-qa.mjs','tests/roster-base-stat-ownership-qa.mjs'],
