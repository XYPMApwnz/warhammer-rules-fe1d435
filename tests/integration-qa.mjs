...
const books={
  'death-guard':{version:'9',reader:'reader.html',versions:{'styles/tokens.css':'11','styles/layout.css':'11','styles/navigation.css':'12','styles/content.css':'38','styles/popups.css':'17','scripts/roster-filter.js':'17','scripts/navigation-controller.js':'16','scripts/popup-controller.js':'25','scripts/full-entry-controller.js':'9','scripts/journey-controller.js':'13','scripts/ui-controllers.js':'12','scripts/app.js':'41'},app:'scripts/app.js',usesPopupGlossary:true,files:['assets/icon-v4.svg','styles/tokens.css','styles/layout.css','styles/navigation.css','styles/content.css','styles/popups.css','scripts/roster-filter.js','scripts/navigation-controller.js','scripts/popup-controller.js','scripts/full-entry-controller.js','scripts/journey-controller.js','scripts/ui-controllers.js','scripts/app.js']},
