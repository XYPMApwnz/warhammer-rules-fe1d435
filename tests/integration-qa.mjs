...
const books={
  'death-guard':{version:'9',reader:'reader.html',versions:{'styles/tokens.css':'11','styles/layout.css':'10','styles/navigation.css':'12','styles/content.css':'36','styles/popups.css':'17','scripts/roster-filter.js':'14','scripts/navigation-controller.js':'15','scripts/popup-controller.js':'25','scripts/full-entry-controller.js':'8','scripts/journey-controller.js':'12','scripts/ui-controllers.js':'12','scripts/related-rules.js':'9','scripts/app.js':'34'},app:'scripts/app.js',usesPopupGlossary:true,files:['assets/icon-v4.svg','styles/tokens.css','styles/layout.css','styles/navigation.css','styles/content.css','styles/popups.css','scripts/roster-filter.js','scripts/navigation-controller.js','scripts/popup-controller.js','scripts/full-entry-controller.js','scripts/journey-controller.js','scripts/ui-controllers.js','scripts/related-rules.js','scripts/app.js']},
...
for(const slug of generatedArmyBooks){
  ...
  const relatedRuntimeVersion=visibleGeneratedArmyBooks.has(slug)?7:5;
...
check('Roster Guides compare current Army Book points without blocking save',rosterGuides.includes('points-data.js?v=6')&&rosterGuides.includes('points-validator.js?v=3')&&rosterGuidesApp.includes('window.WHRosterPoints.check')&&rosterGuidesApp.includes('Points warning:')&&rosterGuidesApp.includes('The roster was still saved.')&&!rosterGuidesApp.includes('Roster is ready to build.'));
...
check('Mega Glossary return UI is shared, versioned and precached',read('glossary/index.html').includes('id="libraryBack"')&&read('glossary/index.html').includes('../glossary-return.js?v=2')&&read('glossary/index.html').includes('viewer.js?v=11')&&sw.includes('"./glossary-return.js?v=2"')&&sw.includes('"./glossary/viewer.js?v=11"')&&sw.includes('"./glossary/viewer-progressive.css?v=3"'));
