...
const books={
  'death-guard':{version:'9',reader:'reader.html',versions:{'styles/tokens.css':'11','styles/layout.css':'11','styles/navigation.css':'12','styles/content.css':'38','styles/popups.css':'17','scripts/roster-filter.js':'14','scripts/navigation-controller.js':'16','scripts/popup-controller.js':'25','scripts/full-entry-controller.js':'9','scripts/journey-controller.js':'13','scripts/ui-controllers.js':'12','scripts/related-rules.js':'11','scripts/app.js':'38'},app:'scripts/app.js',usesPopupGlossary:true,files:['assets/icon-v4.svg','styles/tokens.css','styles/layout.css','styles/navigation.css','styles/content.css','styles/popups.css','scripts/roster-filter.js','scripts/navigation-controller.js','scripts/popup-controller.js','scripts/full-entry-controller.js','scripts/journey-controller.js','scripts/ui-controllers.js','scripts/related-rules.js','scripts/app.js']},
...
check('Death Guard Compatible Stratagems offline chain is versioned and precached',[
  './books/death-guard/scripts/app.js?v=38',
  './books/death-guard/mobile/mobile.js?v=19',
...
check('Army books use one shared unit eligibility matcher',read('books/death-guard/reader.html').includes('shared/related-rules-matcher.js?v=6')&&read('books/death-guard/mobile/mortarion.html').includes('shared/related-rules-matcher.js?v=6')&&read('books/adeptus-mechanicus/reader.html').includes('shared/related-rules-matcher.js?v=6'));
check('Compatible Rules safety flag stays central while only the DG review matrix is enabled',read('books/shared/related-rules-matcher.js').includes('enabled:false')&&read('books/shared/army-related-rules.js').includes('WHRelatedRules?.enabled!==true')&&read('books/adeptus-mechanicus/scripts/related-rules.js').includes('WHRelatedRules?.enabled!==true')&&read('books/death-guard/scripts/compatible-stratagems-runtime.mjs').includes('compatibleStratagemsReviewEnabled=true'));
