...
check('Roster Guides preserve the storage contract',rosterGuidesApp.includes("const STORAGE_KEY='wh40k-rosters-v1'")&&rosterGuidesApp.includes('function rosterId(text)')&&rosterGuidesApp.includes("'death guard':'../books/death-guard/reader.html'")&&rosterGuides.includes('app.js?v=10')&&sw.includes('./roster-guides/app.js?v=10'));
...
check('Roster Guides recognise the four supported factions and expose only real readers',rosterGuidesApp.includes("new Set(['death guard','adeptus mechanicus','tyranids','t au empire'])")&&rosterGuidesApp.includes("'death guard':'../books/death-guard/reader.html'")&&rosterGuidesApp.includes("'adeptus mechanicus':'../books/adeptus-mechanicus/index.html'")&&rosterGuidesApp.includes("'tyranids':'../books/tyranids/index.html'")&&rosterGuidesApp.includes("'t au empire':'../books/tau-empire/index.html'"));
