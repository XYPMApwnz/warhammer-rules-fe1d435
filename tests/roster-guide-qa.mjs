...
for(const bookId of supported){
  ...
  if(bookId==='adeptus-mechanicus'){
    ...
    assert(reader.includes('./scripts/app.js?v=29')&&fs.existsSync(path.join(root,'books','adeptus-mechanicus','scripts','compatible-rules-runtime.mjs')),'adeptus-mechanicus: matrix-backed Compatible Rules controller is absent');
