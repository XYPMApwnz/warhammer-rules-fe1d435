...
assert.match(css,new RegExp(`full-related-content[\\s\\S]*${readableStratagemGrid.source}`),'Compatible Stratagem grids must use the same responsive minimum card width');
