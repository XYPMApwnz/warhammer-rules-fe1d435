...
const migratedBooks=new Map([['death-guard',48],['adeptus-mechanicus',47],['tau-empire',49],['tyranids',65],['emperors-children',36],['chaos-space-marines',74],['space-marines',129],['dark-angels',127],['blood-angels',126]]);
